...
import { RegistrationResult, RegistrationStatus } from '@/entities/auth/RegistrationResult';
import { ChangePasswordResult, ChangePasswordStatus } from '@/entities/auth/ChangePasswordResult';
